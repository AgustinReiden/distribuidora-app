    ...
    <>
      ...
      >
        <div className="space-y-4">
          {/* Input de porcentaje */}
          <div>
            <label htmlFor="pct-aumento" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
            ...
            <p id="pct-help" className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500"
            ...
            <select
              ...
              className="w-full px-3 py-2 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500"
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm">
            <button
              ...
              className="px-3 py-1.5 rounded-md bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-900/50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {seleccionados.size > 0 && (
              <button
                ...
                className="px-3 py-1.5 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
              >
                Limpiar selección
              </button>
            )}
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 dark:bg-gray-800 sticky top-0 z-10">
                  <tr className="text-left text-gray-700 dark:text-gray-300">
                    ...
                    <th className="px-3 py-2 hidden sm:table-cell">Proveedor</th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 py-2">
                          ...
                          {p.codigo && (
                            <div className="text-xs text-gray-500 dark:text-gray-400">{p.codigo}</div>
                          )}
                        </td>
          ...
          {productosSeleccionados.length > 0 && porcentajeValido && (
            <div className="bg-gray-50 dark:bg-gray-800/50 border dark:border-gray-700 rounded-lg p-3">
              <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">
                Vista previa (precio final, primeros {Math.min(PREVIEW_LIMIT, productosSeleccionados.length)} de {productosSeleccionados.length}):
              </p>
              <ul className="space-y-1 text-sm">
                {previewItems.map(({ producto, nuevos }) => (
                  <li key={producto.id} className="flex items-center justify-between text-gray-700 dark:text-gray-300">
                    <span className="truncate mr-2">{producto.nombre}</span>
                    <span className="font-mono whitespace-nowrap">
                      {formatPrecio(producto.precio)} →{' '}
                      <span className={porcentaje >= 0 ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'}>
