-- ============================================================================
-- 045 — actualizar_pedido_items: corre ventana de edicion preventista a 15:30
-- ============================================================================
-- Cambio unico respecto a 034:
--   La ventana de edicion del preventista pasa de < 17:00 ARG a < 15:30 ARG.
--   Para soportar granularidad de minutos, v_hora_corte deja de ser INT y
--   pasa a TIME, y la comparacion ya no usa EXTRACT(HOUR ...) sino que
--   compara el componente time del momento actual en ARG contra '15:30'.
--   El resto del cuerpo (validacion de creador, mismo dia, precio <= base,
--   stock, bonificaciones, auto-ajuste, historial) queda identico al de 034.
-- ============================================================================
