 ...
 *
 * ⚠ AUTO-SYNCED desde src/utils/orquestacionPrecios.fixture.ts — NO EDITAR ACÁ.
...
import type { ItemPedido, PricingMap, GrupoPrecioInfo } from './precioMayorista.ts'
import type { PromoMap, PromocionActiva } from './promociones.ts'
import type { ClienteConDescuentos, ProductoConCategoria } from './descuentoCliente.ts'
import type { OrquestacionPreciosInput } from './orquestacionPrecios.ts'
